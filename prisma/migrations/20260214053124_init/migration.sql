/*
  ...
  - Made the column `averageRating` on table `doctor` required. This step will fail if there are existing NULL values in that column.
...
-- RenameIndex
ALTER INDEX "idx_doctor_email_index" RENAME TO "idx_doctor_email";
